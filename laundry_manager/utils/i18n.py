...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "col_wash_rm": "Wash (SAR)",
        "col_iron_rm": "Iron (SAR)",
        "col_dry_rm": "Dry Clean (SAR)",
        "col_status": "Status",
        ...
        "initial_password_title": "Secure Your Account",
        "initial_password_message": "For security, set a new password before continuing.",
        "initial_password_cancelled": "You must change the default password before signing in.",
        "password_minimum_8": "Password must contain at least 8 characters.",
        "order_items_required": "Please add at least one item.",
        "order_customer_required": "Please select a customer or company.",
        "order_save_failed": "Failed to save order:\n{error}",
        "invoice_not_found": "No invoice found for this order.",
        "invoice_ready": "Invoice is ready for viewing.",
        "generated_file_not_found": "Generated file not found.",
        "print_preview_failed": "Could not open print preview: {error}",
        "pdf_saved": "PDF saved to {path}",
        "pdf_save_failed": "Could not save PDF: {error}",
        "save_pdf": "Save PDF",
        "pdf_files": "PDF Files (*.pdf)",
        "thank_you": "THANK YOU!",
        "unexpected_error": "Unexpected Error",
        "unexpected_error_message": "The application encountered an error.",
        "details_saved": "Details saved to:\n{path}",
        "database_error": "Database Error",
        "database_init_failed": "Failed to initialize database:\n{error}",
        "delete_failed": "Could not delete this record:\n{error}",
        "no_image": "No Image",
        "temporary_price": "Temp. Price",
        "temporary_price_hint": "This changes the price for this order only. The catalog price is unchanged.",
        "service": "Service",
        "edit_order_items": "Edit Services and Quantities",
        "order_updated": "Order updated successfully.",
        "no_report_data": "No data available yet",
        "invoice_qr_hint": "Scan this QR code to read the invoice details.",
    },
    "ar": {
        ...
        "initial_password_title": "تأمين الحساب",
        "initial_password_message": "لأسباب أمنية، أدخل كلمة مرور جديدة قبل المتابعة.",
        "initial_password_cancelled": "يجب تغيير كلمة المرور الافتراضية قبل تسجيل الدخول.",
        "password_minimum_8": "يجب أن تتكون كلمة المرور من 8 أحرف على الأقل.",
        "order_items_required": "يرجى إضافة عنصر واحد على الأقل.",
        "order_customer_required": "يرجى اختيار عميل أو شركة.",
        "order_save_failed": "تعذر حفظ الطلب:\n{error}",
        "invoice_not_found": "لا توجد فاتورة لهذا الطلب.",
        "invoice_ready": "الفاتورة جاهزة للعرض.",
        "generated_file_not_found": "لم يتم العثور على الملف المُنشأ.",
        "print_preview_failed": "تعذر فتح معاينة الطباعة: {error}",
        "pdf_saved": "تم حفظ ملف PDF في {path}",
        "pdf_save_failed": "تعذر حفظ ملف PDF: {error}",
        "save_pdf": "حفظ PDF",
        "pdf_files": "ملفات PDF (*.pdf)",
        "thank_you": "شكرًا لك!",
        "unexpected_error": "خطأ غير متوقع",
        "unexpected_error_message": "واجه البرنامج خطأً غير متوقع.",
        "details_saved": "تم حفظ التفاصيل في:\n{path}",
        "database_error": "خطأ في قاعدة البيانات",
        "database_init_failed": "تعذر تهيئة قاعدة البيانات:\n{error}",
        "delete_failed": "تعذر حذف هذا السجل:\n{error}",
        "no_image": "لا توجد صورة",
        "temporary_price": "سعر مؤقت",
        "temporary_price_hint": "يتغير السعر لهذا الطلب فقط ولا يتغير سعر الكتالوج.",
        "service": "الخدمة",
        "edit_order_items": "تعديل الخدمات والكميات",
        "order_updated": "تم تحديث الطلب بنجاح.",
        "no_report_data": "لا توجد بيانات للعرض بعد",
        "invoice_qr_hint": "امسح رمز QR لقراءة تفاصيل الفاتورة.",
    }
}
def get_lang() -> str:
